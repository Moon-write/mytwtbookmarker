...
public class EmailServiceImpl implements EmailService{
	...
	@Inject
	JavaMailSender mailSender; // root-context.xml에 설정한 bean의 의존성 주입
	
	@Override
	public String sendMail(Email email) {
		// 인증번호 안내 메일양식 작성
		email.setSenderMail("twitterBookmarker");
		email.setSenderName("My Twitter Bookmarker");
		email.setSubject("[MY TWITTER BOOKMARKER] 인증번호를 확인해 주세요!");
		...
		email.setMessage("고객님의 인증번호는 ["+verifyCode+"] 입니다.");
